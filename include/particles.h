...
// NOTE: this needs to be trivially allocatable.
    ...
    public:
        StatefulElectron(const Electron &electron, const ParticleState &state) : Electron(electron),
                                                                                 ParticleState(state) {}
    };

    class StatefulPositron : public Positron, public ParticleState {
    public:
        StatefulPositron(const Positron &positron, const ParticleState &state) : Positron(positron),
                                                                                 ParticleState(state) {}
    };
