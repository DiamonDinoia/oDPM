...
class SeltzerBerger : public WalkersApproximator {
   public:
    ...
    ODPM_INLINE ODPM_PURE constexpr real_type energyTransfer(real_type energy, real_type rndm1, real_type rndm2,
...
class MollerEnergyTransfer : public WalkersApproximator {
   public:
    MollerEnergyTransfer(size_t numPrimaryEnergies, size_t numSecondaryEnergies, real_type minPrimaryEnergy,
        ...
        : WalkersApproximator(numPrimaryEnergies, numSecondaryEnergies, minPrimaryEnergy, invLogDeltaPrimaryEnergy,
                              data) {}
    ...
    ODPM_INLINE ODPM_PURE constexpr real_type sampleEnergyTransfer(real_type energy, real_type rndm1, real_type rndm2,
...
class ODPMElectronData {
   public:
    ...
    ODPM_INLINE ODPM_PURE constexpr real_type mollerEnergyTransfer(real_type energy, real_type rndm1, real_type rndm2,
                                                                   real_type rndm3) const noexcept {
