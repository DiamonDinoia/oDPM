...
namespace opmc {
    ...
    template
    std::vector<G4String> saveMaterialNames(const std::vector<G4String> &materials);

    template
    std::vector<G4String> saveMaterialNames(const std::vector<G4Material *> &materials);

    template
    class DPMTables<G4Material *>;

    template
    class DPMTables<G4String>;

    template
    class DPMTables<std::string>;
}  // namespace opmc