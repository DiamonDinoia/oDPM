...
NB_MODULE(pyodpm_ext, m) {
    ...
    nb::class_<opmc::PhotonPencilBeam>(m, "PhotonPencilBeam")
            .def(nb::init<opmc::ThreeVector<double>, opmc::ThreeVector<double>, double>());
    nb::class_<opmc::Run<opmc::HalfDistanceVoxelCube>>(m, "Run")
            .def(nb::init<std::uint64_t>());
    m.def("simulate", [](opmc::Run<opmc::HalfDistanceVoxelCube> &run,
                         const OPMCG4Run &g4Run,
                         opmc::HalfDistanceVoxelCube &voxelMap,
                         opmc::ElectronPencilBeam &beam,
    ...
    m.def("validate",
          [](opmc::HalfDistanceVoxelCube &a, opmc::HalfDistanceVoxelCube &b) {
