 ...
 *
 * To determine which hypothesis is the most ODPM_LIKELY, we must shape
 ...
 * consider as anomalies only those that are more ODPM_LIKELY to be attacks
...
double KsTestD(const std::vector<double> &vector1, const std::vector<double> &vector2) {
    std::list<double> sample1(vector1.begin(), vector1.end());
    std::list<double> sample2(vector2.begin(), vector2.end());
